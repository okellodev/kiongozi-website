    ...
    <div className="min-h-screen" style={{ backgroundColor: theme.dark, color: theme.text, fontFamily: 'system-ui, -apple-system, sans-serif' }}>
      ...
      <section style={{ padding: '100px 20px', background: `linear-gradient(180deg, ${theme.dark}, ${theme.surface})`, position: 'relative', zIndex: 1 }}>
        <div style={{ maxWidth: '900px', margin: '0 auto', textAlign: 'center' }}>
          ...
          <p style={{ color: theme.textMuted, fontSize: '1.2rem', marginBottom: '40px', fontStyle: 'italic' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(400px, 1fr))', gap: '20px', textAlign: 'left' }}>
            {[
              "You choose quality over price — because you know true craftsmanship is an investment.",
              "You believe your presence should be felt before you ever speak.",
              "You know what you wear reflects who you are — and you refuse to blend in.",
              "You are building something that should last — a career, a legacy, a life of impact.",
              "You are driven by principles, not trends.",
              "You know true luxury isn’t about logos — it’s about how it makes you feel."
            ].map((text, i) => (
              <div key={i} style={{ display: 'flex', gap: '15px', alignItems: 'center', padding: '15px' }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill={theme.primary}><path d="M21 7L9 19L3.5 13.5L4.91 12.09L9 16.17L19.59 5.59L21 7Z"/></svg>
                <p style={{ color: theme.text, fontSize: '1rem', fontWeight: 500 }}>{text}</p>
              </div>
            ))}
          </div>
        </div>
            ...
            <div>
              ...
              <div style={{ color: theme.textMuted, fontSize: '0.85rem', lineHeight: 1.8, display: 'flex', flexDirection: 'column', gap: '8px' }}>
                ...
                <a href="tel:+254111955273" style={{ color: 'inherit', textDecoration: 'none', display: 'flex', alignItems: 'center', gap: '8px' }}>
                  ...
                  Call: +254 111 955 273
                </a>
                <a href="sms:+254111955273" style={{ color: 'inherit', textDecoration: 'none', display: 'flex', alignItems: 'center', gap: '8px' }}>
                  <svg width="18" height="18" fill="#007AFF" viewBox="0 0 24 24"><path d="M20 2H4c-1.1 0-1.99.9-1.99 2L2 22l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zM6 9h12v2H6V9zm8 5H6v-2h8v2zm4-5H6V7h12v2z"/></svg>
                  SMS: +254 111 955 273
                </a>
